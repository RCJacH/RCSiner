...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=RCSiner Demo Installer\n"
      else:
        line="OutputBaseFilename=RCSiner Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the RCSiner Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the RCSiner installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=RCSiner Demo installer\n"
     else:
       line="SetupWindowTitle=RCSiner installer\n"
